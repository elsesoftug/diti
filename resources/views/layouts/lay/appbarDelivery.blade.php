...
<body>
    ...
    <script>
        function formatRows(main, prefer, common) {
            return '<tr><td class="col-md-2"><input type="text" value="' +main+ '" class="form-control editable" /></td>' +
                    '<td class="col-xs-6"><input type="text" value="' +prefer+ '" class="form-control editable" /></td>' +
